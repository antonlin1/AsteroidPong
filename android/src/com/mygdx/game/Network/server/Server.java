...
public class Server extends Thread implements NetworkInterface{
    ...
    private ClientToServerMessage clientToServerMessage = new ClientToServerMessage(0.0f);
...
//        this.gameState = gameState;
    ...
    public void setServerToClientData(boolean gameActive, boolean paddleCollision, boolean wallCollision, float paddleX,
        ...
        ServerToClientMessage serverToClientMessage = new ServerToClientMessage(gameActive, paddleCollision,
                wallCollision, paddleX, ballX, ballY, ballXVelocity, ballYVelocity, ballVelocity);
